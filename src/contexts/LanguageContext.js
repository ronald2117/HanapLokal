...
export const translations = {
  en: {
    ...
    loginTitle: 'Welcome to LocalFind!',
    loginSubtitle: 'Sign in to discover local stores near you',
    signupTitle: 'Join LocalFind!',
    ...
    feedbackHelps: 'Your feedback helps us make LocalFind better for everyone! 🙏',
    ...
    guestWelcomeMessage: 'Thank you for using LocalFind! As a guest, you can only view stores and products.',
  ...
  tl: {
    ...
    signupTitle: 'Mag-register sa LocalFind!',
    ...
    feedbackHelps: 'Ang inyong feedback ay tumutulong para mapabuti namin ang LocalFind! 🙏',
    ...
    guestWelcomeMessage: 'Salamat sa paggamit ng LocalFind! Bilang guest, pwede mo lang tingnan ang mga tindahan at produkto.',
