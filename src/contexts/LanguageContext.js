...
export const translations = {
  en: {
    ...
    selectProfileTypeDescription: 'Choose the type that best describes your business',
    selectProfileType: 'Select profile type',
    selectCategoriesDescription: 'Select categories that match your business',
    categoriesSelected: 'categories selected',
    selectCategories: 'Select categories',
    selectedCategories: 'Selected Categories',
    serviceType: 'Service Type',
    serviceTypeDescription: 'Specify if you provide mobile or on-site services',
    mobileService: 'Mobile Service',
    serviceRadius: 'Service Radius',
    contactNumbers: 'Contact Numbers',
    contactNumbersDescription: 'Add contact numbers for customers to reach you',
    selectContactType: 'Select Contact Type',
    enterContactNumber: 'Enter contact number',
    addContactNumber: 'Add Contact Number',
    contactNumbersNote: 'At least one contact number is required for customers to reach you.',
  },
  ...
  tl: {
    ...
    // Edit Store Screen
    editStore: 'I-edit ang Store',
    updateStoreInformation: 'I-update ang impormasyon ng store',
    businessName: 'Pangalan ng Negosyo',
    enterBusinessName: 'Ilagay ang pangalan ng negosyo',
    profileType: 'Uri ng Profile',
    selectProfileTypeDescription: 'Piliin ang uri na pinakasuot sa inyong negosyo',
    selectProfileType: 'Piliin ang uri ng profile',
    selectCategoriesDescription: 'Piliin ang mga kategorya na tumugma sa inyong negosyo',
    categoriesSelected: 'mga kategorya na napili',
    selectCategories: 'Piliin ang mga kategorya',
    selectedCategories: 'Mga Napiling Kategorya',
    serviceType: 'Uri ng Serbisyo',
    serviceTypeDescription: 'Tukuyin kung nagbibigay kayo ng mobile o on-site na serbisyo',
    mobileService: 'Mobile Service',
    serviceRadius: 'Saklaw ng Serbisyo',
    contactNumbers: 'Mga Contact Number',
    contactNumbersDescription: 'Magdagdag ng mga contact number para makontak kayo ng mga customer',
    selectContactType: 'Piliin ang Uri ng Contact',
    enterContactNumber: 'Ilagay ang contact number',
    addContactNumber: 'Magdagdag ng Contact Number',
    contactNumbersNote: 'Kailangan ng hindi bababa sa isang contact number para makontak kayo ng mga customer.',
  },
};
