...
export const BUSINESS_CATEGORIES = [
  ...
  { id: 'creative', name: 'Creative & Design', icon: 'color-palette', types: ['freelancer', 'student', 'events-venue'] },
  ...
  { id: 'events', name: 'Events & Entertainment', icon: 'musical-notes', types: ['service-provider', 'freelancer', 'events-venue'] },
  ...
  { id: 'venue-rental', name: 'Venue Rental', icon: 'business', types: ['events-venue'] },
